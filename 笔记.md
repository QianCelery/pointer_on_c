...
![](C:\source\pointer_on_c\图片\单链表.png)
...
可以以任何方向遍历双链表。
   ...
   ![](C:\source\pointer_on_c\图片\双链表.png)
   **节点类型声明：**
...
![](C:\source\pointer_on_c\图片\宏与函数的不同之处.png)
...
![](C:\source\pointer_on_c\图片\IO函数.png)

![](C:\source\pointer_on_c\图片\输入输出函数家族.png)
